<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      <input type="checkbox" id="confirmed-terms" name="confirm-terms" v-model="confirm">
      <label for="confirmed-terms">Agree to terms of use?</label>
    </div>
    <div>
...
export default ({
  ...
  data() {
    return {
      ...
      userAge: null,
      referrer: 'wom',
      interest: [], // By adding an array vue will add those elements individualy add also add values in checkboxes
      // interest: null, This makes vue select all elements at once
      how: null,
      confirm: false, // If we have a single checkbox we get true pr false instead of an array
